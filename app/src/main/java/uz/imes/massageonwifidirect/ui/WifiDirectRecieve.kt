 ...
 */
//class WifiDirectRecieve(var manager:WifiP2pManager,var channel:WifiP2pManager.Channel,var activity:CreatedHostActivity): BroadcastReceiver() {
//
//
